import { Search, Bell, Moon, Sun, ChevronDown, CheckSquare, Lock, X, CheckCheck } from 'lucide-react';
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-20">
