...
export default function AcceptInvite() {
  ...
  useEffect(() => {
    // Listen for Supabase to process the invite token from URL hash
    ...
    // Also check existing session (reload case)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Verifying your invite link...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Set your password to get started</p>
        </div>
